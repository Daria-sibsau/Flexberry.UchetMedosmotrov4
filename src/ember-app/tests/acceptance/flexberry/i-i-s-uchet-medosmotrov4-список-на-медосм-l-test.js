...
moduleForAcceptance('[AGAT] Acceptance | i i s uchet medosmotrov4 список на медосм l');

test('testing i-i-s-uchet-medosmotrov4-список-на-медосм-l', function(assert) {
